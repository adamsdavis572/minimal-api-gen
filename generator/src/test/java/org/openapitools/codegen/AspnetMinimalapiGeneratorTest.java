 ...
 * 1) Set a break point in AspnetMinimalapiGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class AspnetMinimalapiGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("aspnet-minimalapi") // use this codegen library
              ...
              .setOutputDir("out/aspnet-minimalapi"); // output directory
